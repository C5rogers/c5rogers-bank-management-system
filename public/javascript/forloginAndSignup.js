...
var forinput5 = document.querySelector(".forinput5");
var forinput6 = document.querySelector(".forinput6");
...
var isAllEmpty1 = function() {
    ...
    var count5 = input5.value.length;
    var count6 = input6.value.length;
    ...
    if (submitterName == "signup") {
        if (isAllEmpty1()) {
            ...
            if (inputCheker(input1)) {
                ...
                e.preventDefault();
                makeErrorMessage("phone number is also needed!", forinput5);
            } else if (inputCheker(input6)) {
                e.preventDefault();
                makeErrorMessage("location is also neded!", forinput6);
            }
        }
...
// this will listen the phone number in put
input5.addEventListener('input', function(e) {
    if (this.value.length > 10) {
        this.style.border = "1px solid red";
        forinput5.innerHTML = "out of range!";
    } else {
        this.style.border = "1px solid gold";
        forinput5.innerHTML = "";
    }
